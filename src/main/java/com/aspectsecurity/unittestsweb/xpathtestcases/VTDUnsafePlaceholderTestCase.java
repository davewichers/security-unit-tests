...
@WebServlet("/vtdunsafeplaceholder")
public class VTDUnsafePlaceholderTestCase extends XPathTestCase {

    /*
     * VTD-XML: Unsafe when Using String Placeholders on XPath Expression Example
