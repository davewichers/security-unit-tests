...
@WebServlet("/xmlinput2unsafevalidationon")
public class XMLInput2UnsafeValidationOnTestCase extends XXETestCase {

    /*
     * XMLInputFactory2: Unsafe when Enabling Validation Example
     * Proves that enabling validation for the XMLInputFactory2 leaves the XMLStreamReader parsing entities
     */
