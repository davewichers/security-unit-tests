...
@WebServlet("/xpathunsafeplaceholder")
public class XPathUnsafePlaceholderTestCase extends XPathTestCase {

    /*
     * Java XPath: Unsafe when Using String Placeholders on XPathExpression Example
