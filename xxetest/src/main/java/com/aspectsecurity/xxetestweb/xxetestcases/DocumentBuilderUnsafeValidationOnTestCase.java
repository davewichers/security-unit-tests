...
@WebServlet("/documentbuilderunsafevalidationon")
public class DocumentBuilderUnsafeValidationOnTestCase extends XXETestCase {

    /*
     * DocumentBuilder: Unsafe when Enabling Validation Example
