<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.io.BufferedReader,java.io.FileReader,java.io.IOException,java.net.URL,java.io.InputStreamReader"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Safe Schema</title>
</head>
<body>

<h1>Safe when Disallowing External DTDs and Schemas on the Validator Example</h1>
...
<br>
<form id="theform" action="schemasafevalidator" method="get" autocomplete="off">
