...
<title>Unsafe XMLReader</title>
</head>
<body>

<h1>Unsafe when Enabling External General and Parameter Entities Example</h1>
...
<br>
<form id="theform" action="xmlreaderunsafeexternal" method="get" autocomplete="off">
