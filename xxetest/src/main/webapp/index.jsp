...
if (System.getProperty("java.version").startsWith("1.8"))
	out.println("Unsafe Tests: 21 <br> Safe Tests: 16</h3>");
else if (System.getProperty("java.version").startsWith("1.7"))
	out.println("Unsafe Tests: 24 <br> Safe Tests: 13</h3>");
else
...
<ul>
	...
	<ul>
		...
		<li><a href="xmlview.jsp?title=Safe%20Schema&test=Schema%3A%20Safe%20when%20Disallowing%20External%20DTDs%20and%20Schemas%20Example&var=schemasafe">Safe when Disallowing External DTDs and Schemas Example</a></li>
		<li><a href="xmlview.jsp?title=Safe%20Schema&test=Safe%20when%20Disallowing%20External%20DTDs%20and%20Schemas%20on%20the%20Validator%20Example&var=schemasafevalidator">Safe when Disallowing External DTDs and Schemas on the Validator Example</a></li>
	</ul><br />
	</li>
	...
	<ul>
		...
		<li><a href="xmlview.jsp?title=Safe%20Transformer&test=Transformer%3A%20Safe%20when%20Disallowing%20External%20DTDs%20in%20Java%201.8%20Example&var=transformersafeaccess">Safe when Disallowing External DTDs in Java 1.8 Example</a></li>
	</ul><br />
	</li>
	...
	<ul>
		...
		<li><a href="xmlview.jsp?title=Safe%20XMLInputFactory&test=XMLInputFactory%3A%20Safe%20when%20Disallowing%20External%20DTDs%20in%20Java%201.8%20Example&var=xmlinputsafeaccess">Safe when Disallowing External DTDs in Java 1.8 Example</a></li>
