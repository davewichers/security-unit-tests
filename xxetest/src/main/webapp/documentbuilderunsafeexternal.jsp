...
<title>Unsafe DocumentBuilder</title>
</head>
<body>

<h1>Unsafe when Enabling External General Entities Example</h1>
...
<br>
<form id="theform" action="documentbuilderunsafeexternal" method="get" autocomplete="off">
