...
<ul>
	...
	<li><a href="http://www.saxonica.com/html/documentation/javadoc/net/sf/saxon/s9api/package-summary.html">net.sf.saxon.s9api (link to <b>Saxonica Saxon9</b> Javadoc)</a>
		<ul>
			<li><a href="xmlqueryview.jsp?title=Unsafe%20Saxon&test=Saxon%3A%20Unsafe%20when%20Using%20String%20Concatenation%20on%20XPath%20Expression%20Example&var=saxonunsafeconcat">Unsafe when Using String Concatenation on XPath Expression Example</a></li>
			<li><a href="xmlqueryview.jsp?title=Unsafe%20Saxon&test=Saxon%3A%20Unsafe%20when%20Using%20String%20Placeholders%20on%20XPath%20Expression%20Example&var=saxonunsafeplaceholder">Unsafe when Using String Placeholders on XPath Expression Example</a></li>
			<li><a href="xmlqueryview.jsp?title=Safe%20Saxon&test=Saxon%3A%20Safe%20when%20Parameterizing%20on%20XPath%20Expression%20Example&var=saxonsafeparam">Safe when Parameterizing on XPath Expression Example</a></li>
			<li><a href="xmlqueryview.jsp?title=Safe%20Saxon&test=Saxon%3A%20Safe%20when%20Escaping%20Apostrophes%20on%20XPath%20Expression%20Example&var=saxonsafeescape">Safe when Escaping Apostrophes on XPath Expression Example</a></li>
		</ul>
		<br />
	</li>
</ul>
