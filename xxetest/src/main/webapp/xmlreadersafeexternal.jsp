...
<title>Safe XMLReader</title>
</head>
<body>

<h1>Safe when Disabling External General and Parameter Entities Example</h1>
...
<br>
<form id="theform" action="xmlreadersafeexternal" method="get" autocomplete="off">
