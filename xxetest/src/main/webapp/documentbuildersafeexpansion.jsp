...
<title>"Safe" DocumentBuilder</title>
</head>
<body>

<h1>"Safe" when Disabling Entity Expansion Example (FAILURE)</h1>
<h2 style="color:red">NOTE: Although this is supposed to make DocumentBuilder safe according to Java documentation, it doesn't</h2>
...
<br>
<form id="theform" action="documentbuildersafeexpansion" method="get" autocomplete="off">
