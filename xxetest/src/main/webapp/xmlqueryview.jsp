...
<a href='codeview.jsp?type=xmlquery&test=<%= request.getParameter("test") %>'>View code for this test</a>
<br /><br />
<h3>The following is the XML file the query will be performed on:</h3>
<textarea title="Students" rows="15" cols="150" name="payload" form="theform" disabled="disabled">
<%
...
<br>
<form id="theform" action="xmlqueryresults" method="get" autocomplete="off">
    ...
    Enter first name: <input title="Payload" type="text" name="payload" value="Bobby&apos; or &apos;a&apos;=&apos;a" />
    <input type="submit" value="Submit">
</form>

<br /><br /><a href="xmlquery.jsp">&lt&lt&lt back to tests</a>
