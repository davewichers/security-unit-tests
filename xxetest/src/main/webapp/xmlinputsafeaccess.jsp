...
<title>Safe XMLInputFactory</title>
</head>
<body>

<h1>Safe when Disallowing External DTDs in Java 1.8 Example</h1>
<%
if (!System.getProperty("java.version").startsWith("1.8"))
	out.println("<h2 style=\"color:red\">NOTE: THIS APP IS CURRENTLY RUNNING JAVA 1.7 OR LESS, WHICH LEAVES THIS UNSAFE</h2>");
%>
...
<br>
<form id="theform" action="xmlinputsafeaccess" method="get" autocomplete="off">
